...
export default function Footer() {
  ...
  const socialLinks: SocialLink[] = [
    { name: "GitHub", icon: Github, href: "https://github.com/bonfacecodes" },
    {
      name: "LinkedIn",
      icon: Linkedin,
      href: "https://linkedin.com/in/bonfacecodes",
    },
    {
      name: "Twitter",
      icon: Twitter,
      href: "https://twitter.com/bonfacecodes",
    },
    { name: "Email", icon: Mail, href: "mailto:bonface@bonfacecodes.com" },
  ];
